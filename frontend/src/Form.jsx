      ...
      >
        ...
        <button
          ...
          className="bg-gradient-to-r from-cyan-400 to-blue-600 text-white font-bold px-8 py-3 rounded-full shadow-lg
                 hover:shadow-[0_0_25px_rgba(0,200,255,0.6)] transition-transform duration-300"
        >
          Upload Image(s)
        </button>
      </form>
          ...
          <div className="flex flex-wrap gap-8 justify-center">
            {selectedImages.map((img, index) => (
              <motion.div
                ...
                className="w-56 h-56 bg-white/10 backdrop-blur-md border border-black border-3 
